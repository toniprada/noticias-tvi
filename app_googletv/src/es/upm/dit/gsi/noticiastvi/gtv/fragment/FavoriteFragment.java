...
import es.upm.dit.gsi.noticiastvi.gtv.thread.FavoritesThread;
import es.upm.dit.gsi.noticiastvi.gtv.thread.GetItemsThread;

/**
 * Fragment to show the favorites.
 * 
 * @author Antonio Prada <toniprada@gmail.com>
 * 
 */
public class FavoriteFragment extends FragmentItemsFromServer {
	...
	public GetItemsThread getThread(Handler handler) {
		return new FavoritesThread(handler, mAccount.getName());
	}
