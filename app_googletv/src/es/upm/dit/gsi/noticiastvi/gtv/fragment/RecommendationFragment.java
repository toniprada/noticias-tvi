...
import es.upm.dit.gsi.noticiastvi.gtv.thread.RecommendationThread;
 ...
 * 
 */
public class RecommendationFragment extends FragmentItemsFromServer {
	
//	private String user;

	public RecommendationFragment(Context context, Account account) {
