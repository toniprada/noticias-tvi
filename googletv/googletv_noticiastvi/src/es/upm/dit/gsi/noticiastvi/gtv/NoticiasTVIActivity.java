...
//		ActionBar.Tab tabStream = bar.newTab().setText(getText(R.string.stream));
		...
		iv.setImageResource(R.drawable.ic_menu_cc);
		TextView tv = (TextView) v.findViewById(R.id.title);
		tv.setText(mAccount.getNombre());
		tabUser.setCustomView(v);
//		tabUser.setCustomView();
...
//			bar.selectTab(tab);
//		}
        bar.setCustomView(R.layout.custom_logo);
